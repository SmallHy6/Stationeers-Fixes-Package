...
namespace Stationeers_Fixes_Package
{
    ...
    [HarmonyPatch(typeof(NewWorldDifficulty), "DisplaySmartStat", new Type[] { typeof(float), typeof(StringBuilder), typeof(GameString), typeof(float), typeof(bool), typeof(string), typeof(string), typeof(GameString) })]
    public class NewWorldDifficulty_DisplaySmartStat_1_Patch
    {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions) => instructions.修改IL代码中的字符串();
    }

    [HarmonyPatch(typeof(NewWorldDifficulty), "DisplaySmartStat", new Type[] { typeof(float), typeof(StringBuilder), typeof(GameString), typeof(string), typeof(float), typeof(bool), typeof(string), typeof(string), typeof(GameString) })]
